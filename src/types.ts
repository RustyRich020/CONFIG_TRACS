...
export type SavedVersionKind =
  ...
  | 'closure_package_acknowledgement_closeout_export_package_acknowledgement'
  | 'closure_package_acknowledgement_closeout_export_package_acknowledgement_closure'
...
export type PostgresCutoverFinalHandoffClosurePackageAcknowledgement = {
  acknowledgementId: string
  acknowledgedAt: string
  deliveryRecordId: string
  deliveryId: string
  ...
  channelSummary: string
  packageStatus?: StatusLevel
  sourceMetrics?: PostgresCutoverFinalHandoffClosurePackage['metrics']
  sourceRequiredActions: string[]
...
export type ClosureSlaFollowUpClosurePackageAcknowledgementClosure = {
  closureId: string
  closedAt: string
  reviewer: string
  status: ClosureSlaResponseFollowUpClosureStatus
  acknowledgementRecords: Array<BackendRecord<ClosureSlaFollowUpClosurePackageAcknowledgement>>
  closurePackages: Array<BackendRecord<ClosureSlaFollowUpClosureExportPackage>>
  deliveryEvidence: Array<BackendRecord<{
    request: NotificationDeliveryPayload
    result: NotificationDeliveryResult
  }>>
...
export type ClosurePackageAcknowledgementCloseoutExportPackageAcknowledgement = {
  acknowledgementId: string
  acknowledgedAt: string
  deliveryRecordId: string
  deliveryId: string
  ...
  channelSummary: string
  packageStatus?: StatusLevel
  sourceMetrics?: ClosurePackageAcknowledgementCloseoutExportPackage['metrics']
  sourceRequiredActions: string[]
  sourceCloseoutCount: number
  sourceDeliveryEvidenceCount: number
  auditHistory: Array<{
...
export type ClosurePackageAcknowledgementCloseoutExportPackageAcknowledgementClosure = {
  closureId: string
  closedAt: string
  reviewer: string
  status: ClosureSlaResponseFollowUpClosureStatus
  acknowledgementRecords: Array<BackendRecord<ClosurePackageAcknowledgementCloseoutExportPackageAcknowledgement>>
  exportPackages: Array<BackendRecord<ClosurePackageAcknowledgementCloseoutExportPackage>>
  deliveryEvidence: Array<BackendRecord<{
    request: NotificationDeliveryPayload
    result: NotificationDeliveryResult
  }>>
...
export type ClosurePackageAcknowledgementCloseoutNotificationClosure = {
  closureId: string
  closedAt: string
  reviewer: string
  status: ClosureSlaResponseFollowUpClosureStatus
  ...
  acknowledgementRecords: Array<BackendRecord<ClosurePackageAcknowledgementCloseoutExportPackageAcknowledgement>>
  acknowledgementClosures: Array<BackendRecord<ClosurePackageAcknowledgementCloseoutExportPackageAcknowledgementClosure>>
  retryControls: Array<BackendRecord<NotificationDeliveryRetryControl>>
  metrics: {
    exportPackages: number
    deliveryRecords: number
    acknowledgementRecords: number
    acknowledgementClosures: number
    retryControls: number
    retainedActions: number
    rejectedAcknowledgements: number
    changesRequested: number
    readyAcknowledgements: number
    closedAcknowledgementClosures: number
    closedWithActions: number
  }
  retainedActions: string[]
  closureNotes: string
...
export type ClosurePackageAcknowledgementCloseoutNotificationClosurePackage = {
  packageId: string
  generatedAt: string
  closureReviewers: string[]
  status: StatusLevel
  notificationClosureRecords: Array<BackendRecord<ClosurePackageAcknowledgementCloseoutNotificationClosure>>
  exportPackages: Array<BackendRecord<ClosurePackageAcknowledgementCloseoutExportPackage>>
  deliveryEvidence: Array<BackendRecord<{
    request: NotificationDeliveryPayload
    result: NotificationDeliveryResult
...
export type ClosurePackageAcknowledgementCloseoutNotificationClosurePackageAcknowledgement = {
  acknowledgementId: string
  acknowledgedAt: string
  deliveryRecordId: string
  deliveryId: string
  ...
  channelSummary: string
  packageStatus?: StatusLevel
  sourceMetrics?: ClosurePackageAcknowledgementCloseoutNotificationClosurePackage['metrics']
  sourceRequiredActions: string[]
  sourceNotificationClosureCount: number
  sourceDeliveryEvidenceCount: number
  sourceRetryControlCount: number
  auditHistory: Array<{
...
export type ClosurePackageAcknowledgementCloseoutNotificationClosurePackageAcknowledgementClosure = {
  closureId: string
  closedAt: string
  reviewer: string
  status: ClosureSlaResponseFollowUpClosureStatus
...
export type ClosurePackageAcknowledgementCloseoutNotificationClosurePackageAcknowledgementClosurePackageAcknowledgement = {
  acknowledgementId: string
  acknowledgedAt: string
  deliveryRecordId: string
  deliveryId: string
  ...
  channelSummary: string
  packageStatus?: StatusLevel
  sourceMetrics?: ClosurePackageAcknowledgementCloseoutNotificationClosurePackageAcknowledgementClosurePackage['metrics']
  sourceRequiredActions: string[]
  sourceCloseoutRecordCount: number
  sourceDeliveryEvidenceCount: number
  sourceSupersededEvidenceCount: number
  auditHistory: Array<{
    action: 'closure_package_acknowledgement_closeout_notification_closure_package_acknowledgement_closure_package_acknowledged'
    actor: string
    timestamp: string
    status: ClosureSlaDeliveryAcknowledgementStatus
    finalEvidenceReady: boolean
...
export type ClosurePackageAcknowledgementCloseoutNotificationClosurePackageAcknowledgementClosurePackageAcknowledgementFinalEvidence = {
  evidenceId: string
  finalizedAt: string
  reviewer: string
  status: ClosureSlaResponseFollowUpClosureStatus
  acknowledgementRecords: Array<BackendRecord<ClosurePackageAcknowledgementCloseoutNotificationClosurePackageAcknowledgementClosurePackageAcknowledgement>>
  closeoutPackages: Array<BackendRecord<ClosurePackageAcknowledgementCloseoutNotificationClosurePackageAcknowledgementClosurePackage>>
  deliveryEvidence: Array<BackendRecord<{
    request: NotificationDeliveryPayload
    result: NotificationDeliveryResult
  }>>
  ...
  sourceRecordCounts: {
    acknowledgementRecords: number
    closeoutPackages: number
    deliveryRecords: number
    supersededAcknowledgements: number
  }
  auditHistory: Array<{
    action: 'closure_package_acknowledgement_closeout_notification_closure_package_acknowledgement_closure_package_acknowledgement_finalized'
    actor: string
    timestamp: string
    status: ClosureSlaResponseFollowUpClosureStatus
    summary: string
...
export type ClosurePackageAcknowledgementCloseoutNotificationClosurePackageAcknowledgementFinalEvidenceAcknowledgementClosure = {
  closeoutId: string
  closedAt: string
  reviewer: string
  status: ClosureSlaResponseFollowUpClosureStatus
  acknowledgementRecords: Array<BackendRecord<ClosurePackageAcknowledgementCloseoutNotificationClosurePackageAcknowledgementFinalEvidenceAcknowledgement>>
  finalEvidenceRecords: Array<BackendRecord<ClosurePackageAcknowledgementCloseoutNotificationClosurePackageAcknowledgementClosurePackageAcknowledgementFinalEvidence>>
  deliveryEvidence: Array<BackendRecord<{
    request: NotificationDeliveryPayload
    result: NotificationDeliveryResult
  }>>
  ...
  auditHistory: Array<{
    action: 'closure_package_acknowledgement_closeout_notification_closure_package_acknowledgement_final_evidence_acknowledgement_closed'
    actor: string
    timestamp: string
    status: ClosureSlaResponseFollowUpClosureStatus
    summary: string
...
export type ClosurePackageAcknowledgementCloseoutNotificationClosurePackageAcknowledgementFinalEvidenceAcknowledgementClosureDeliveryAcknowledgementClosure = {
  closureId: string
  closedAt: string
  reviewer: string
  status: ClosureSlaResponseFollowUpClosureStatus
  acknowledgementRecords: Array<BackendRecord<ClosurePackageAcknowledgementCloseoutNotificationClosurePackageAcknowledgementFinalEvidenceAcknowledgementClosureDeliveryAcknowledgement>>
  closeoutEvidenceRecords: Array<BackendRecord<ClosurePackageAcknowledgementCloseoutNotificationClosurePackageAcknowledgementFinalEvidenceAcknowledgementClosure>>
  deliveryEvidence: Array<BackendRecord<{
    request: NotificationDeliveryPayload
    result: NotificationDeliveryResult
  }>>
  ...
  auditHistory: Array<{
    action: 'closure_package_acknowledgement_closeout_notification_closure_package_acknowledgement_final_evidence_acknowledgement_closure_delivery_acknowledgement_closed'
    actor: string
    timestamp: string
    status: ClosureSlaResponseFollowUpClosureStatus
    summary: string
...
export type ClosurePackageAcknowledgementCloseoutNotificationClosurePackageAcknowledgementFinalEvidenceAcknowledgementClosureDeliveryAcknowledgementClosureDeliveryAcknowledgement = {
  acknowledgementId: string
  acknowledgedAt: string
  deliveryRecordId: string
  deliveryId: string
  ...
  sourceMetrics?: ClosurePackageAcknowledgementCloseoutNotificationClosurePackageAcknowledgementFinalEvidenceAcknowledgementClosureDeliveryAcknowledgementClosure['metrics']
  sourceRetainedActions: string[]
  sourceAcknowledgementCount: number
  sourceCloseoutEvidenceCount: number
  sourceDeliveryEvidenceCount: number
  sourceSupersededEvidenceCount: number
  auditHistory: Array<{
    action: 'closure_package_acknowledgement_closeout_notification_closure_package_acknowledgement_final_evidence_acknowledgement_closure_delivery_acknowledgement_closure_delivery_acknowledged'
    actor: string
    timestamp: string
    status: ClosureSlaDeliveryAcknowledgementStatus
    finalEvidenceReady: boolean
...
export type ClosurePackageAcknowledgementCloseoutNotificationClosurePackageAcknowledgementFinalEvidenceAcknowledgementClosureDeliveryAcknowledgementClosureDeliveryAcknowledgementFinalEvidence = {
  evidenceId: string
  finalizedAt: string
  reviewer: string
  status: ClosureSlaResponseFollowUpClosureStatus
  acknowledgementRecords: Array<BackendRecord<ClosurePackageAcknowledgementCloseoutNotificationClosurePackageAcknowledgementFinalEvidenceAcknowledgementClosureDeliveryAcknowledgementClosureDeliveryAcknowledgement>>
  acknowledgementClosureRecords: Array<BackendRecord<ClosurePackageAcknowledgementCloseoutNotificationClosurePackageAcknowledgementFinalEvidenceAcknowledgementClosureDeliveryAcknowledgementClosure>>
  deliveryEvidence: Array<BackendRecord<{
    request: NotificationDeliveryPayload
    result: NotificationDeliveryResult
  }>>
  metrics: {
    ...
    finalEvidenceReady: number
    retainedActions: number
    acknowledgementClosureRecords: number
    deliveryRecords: number
  }
  retainedActions: string[]
  finalEvidenceNotes: string
  ...
  auditHistory: Array<{
    action: 'closure_package_acknowledgement_closeout_notification_closure_package_acknowledgement_final_evidence_acknowledgement_closure_delivery_acknowledgement_closure_delivery_acknowledgement_finalized'
    actor: string
    timestamp: string
    status: ClosureSlaResponseFollowUpClosureStatus
    summary: string
...
export type ClosurePackageAcknowledgementCloseoutNotificationClosurePackageAcknowledgementFinalEvidenceAcknowledgementClosureDeliveryAcknowledgementClosureDeliveryAcknowledgementFinalEvidenceDeliveryAcknowledgement = {
  acknowledgementId: string
  acknowledgedAt: string
  deliveryRecordId: string
  deliveryId: string
  ...
  channelSummary: string
  finalEvidenceStatus?: ClosureSlaResponseFollowUpClosureStatus
  sourceMetrics?: ClosurePackageAcknowledgementCloseoutNotificationClosurePackageAcknowledgementFinalEvidenceAcknowledgementClosureDeliveryAcknowledgementClosureDeliveryAcknowledgementFinalEvidence['metrics']
  sourceRetainedActions: string[]
  sourceAcknowledgementCount: number
  sourceAcknowledgementClosureCount: number
  sourceDeliveryEvidenceCount: number
  sourceSupersededEvidenceCount: number
  auditHistory: Array<{
    action: 'closure_package_acknowledgement_closeout_notification_closure_package_acknowledgement_final_evidence_acknowledgement_closure_delivery_acknowledgement_closure_delivery_acknowledgement_final_evidence_delivery_acknowledged'
    actor: string
    timestamp: string
    status: ClosureSlaDeliveryAcknowledgementStatus
    closeoutReady: boolean
...
export type ClosurePackageAcknowledgementCloseoutNotificationClosurePackageAcknowledgementFinalEvidenceAcknowledgementClosureDeliveryAcknowledgementClosureDeliveryAcknowledgementFinalEvidenceDeliveryAcknowledgementCloseoutEvidence = {
  closeoutId: string
  closedAt: string
  reviewer: string
  status: ClosureSlaResponseFollowUpClosureStatus
  acknowledgementRecords: Array<BackendRecord<ClosurePackageAcknowledgementCloseoutNotificationClosurePackageAcknowledgementFinalEvidenceAcknowledgementClosureDeliveryAcknowledgementClosureDeliveryAcknowledgementFinalEvidenceDeliveryAcknowledgement>>
  finalEvidenceRecords: Array<BackendRecord<ClosurePackageAcknowledgementCloseoutNotificationClosurePackageAcknowledgementFinalEvidenceAcknowledgementClosureDeliveryAcknowledgementClosureDeliveryAcknowledgementFinalEvidence>>
  deliveryEvidence: Array<BackendRecord<{
    request: NotificationDeliveryPayload
    result: NotificationDeliveryResult
  }>>
  ...
  auditHistory: Array<{
    action: 'closure_package_acknowledgement_closeout_notification_closure_package_acknowledgement_final_evidence_acknowledgement_closure_delivery_acknowledgement_closure_delivery_acknowledgement_final_evidence_delivery_acknowledgement_closed'
    actor: string
    timestamp: string
    status: ClosureSlaResponseFollowUpClosureStatus
    summary: string
...
export type ClosurePackageAcknowledgementCloseoutNotificationClosurePackageAcknowledgementFinalEvidenceAcknowledgementClosureDeliveryAcknowledgementClosureDeliveryAcknowledgementFinalEvidenceDeliveryAcknowledgementCloseoutEvidenceDeliveryAcknowledgement = {
  acknowledgementId: string
  acknowledgedAt: string
  deliveryRecordId: string
  deliveryId: string
  ...
  channelSummary: string
  closeoutStatus?: ClosureSlaResponseFollowUpClosureStatus
  sourceMetrics?: ClosurePackageAcknowledgementCloseoutNotificationClosurePackageAcknowledgementFinalEvidenceAcknowledgementClosureDeliveryAcknowledgementClosureDeliveryAcknowledgementFinalEvidenceDeliveryAcknowledgementCloseoutEvidence['metrics']
  sourceRetainedActions: string[]
  sourceAcknowledgementCount: number
  sourceFinalEvidenceCount: number
  sourceDeliveryEvidenceCount: number
  sourceSupersededEvidenceCount: number
  auditHistory: Array<{
    action: 'closure_package_acknowledgement_closeout_notification_closure_package_acknowledgement_final_evidence_acknowledgement_closure_delivery_acknowledgement_closure_delivery_acknowledgement_final_evidence_delivery_acknowledgement_closeout_evidence_delivery_acknowledged'
    actor: string
    timestamp: string
    status: ClosureSlaDeliveryAcknowledgementStatus
    acknowledgementClosureReady: boolean
...
export type  = {
  acknowledgementId: string
  acknowledgedAt: string
  deliveryRecordId: string
  deliveryId: string
  ...
  channelSummary: string
  closureStatus?: ClosureSlaResponseFollowUpClosureStatus
  sourceMetrics?: ClosurePackageAcknowledgementCloseoutNotificationClosurePackageAcknowledgementFinalEvidenceAcknowledgementClosureDeliveryAcknowledgementClosureDeliveryAcknowledgementFinalEvidenceDeliveryAcknowledgementCloseoutEvidenceDeliveryAcknowledgementClosure['metrics']
  sourceRetainedActions: string[]
  sourceAcknowledgementCount: number
  sourceCloseoutEvidenceCount: number
  sourceDeliveryEvidenceCount: number
  sourceSupersededEvidenceCount: number
  auditHistory: Array<{
    action: 'closure_package_acknowledgement_closeout_notification_closure_package_acknowledgement_final_evidence_acknowledgement_closure_delivery_acknowledgement_closure_delivery_acknowledgement_final_evidence_delivery_acknowledgement_closeout_evidence_delivery_acknowledgement_closure_delivery_acknowledged'
    actor: string
    timestamp: string
    status: ClosureSlaDeliveryAcknowledgementStatus
    closeoutReady: boolean
...
export type  = {
  closeoutId: string
  closedAt: string
  reviewer: string
  status: ClosureSlaResponseFollowUpClosureStatus
  acknowledgementRecords: Array<BackendRecord<>>
  closureEvidenceRecords: Array<BackendRecord<ClosurePackageAcknowledgementCloseoutNotificationClosurePackageAcknowledgementFinalEvidenceAcknowledgementClosureDeliveryAcknowledgementClosureDeliveryAcknowledgementFinalEvidenceDeliveryAcknowledgementCloseoutEvidenceDeliveryAcknowledgementClosure>>
  deliveryEvidence: Array<BackendRecord<{
    request: NotificationDeliveryPayload
    result: NotificationDeliveryResult
  }>>
  ...
  auditHistory: Array<{
    action: 'closure_package_acknowledgement_closeout_notification_closure_package_acknowledgement_final_evidence_acknowledgement_closure_delivery_acknowledgement_closure_delivery_acknowledgement_final_evidence_delivery_acknowledgement_closeout_evidence_delivery_acknowledgement_closure_delivery_acknowledgement_closed'
    actor: string
    timestamp: string
    status: ClosureSlaResponseFollowUpClosureStatus
    summary: string
...
export type  = {
  acknowledgementId: string
  acknowledgedAt: string
  deliveryRecordId: string
  deliveryId: string
  deliverySubject: string
  closeoutEvidenceRecordId?: string
  closeoutId?: string
  closeoutVersion?: number
  reviewer: string
  reviewerRole: 'governance_reviewer' | 'infrastructure_owner' | 'notification_operations' | 'platform_owner'
  ...
  sourceSupersededEvidenceCount: number
  auditHistory: Array<{
    action: 'closure_package_acknowledgement_closeout_notification_closure_package_acknowledgement_final_evidence_acknowledgement_closure_delivery_acknowledgement_closure_delivery_acknowledgement_final_evidence_delivery_acknowledgement_closeout_evidence_delivery_acknowledgement_closure_delivery_acknowledgement_closeout_evidence_delivery_acknowledged'
    actor: string
    timestamp: string
    status: ClosureSlaDeliveryAcknowledgementStatus
    finalEvidenceReady: boolean
...
export type  = {
  evidenceId: string
  finalizedAt: string
  reviewer: string
  status: ClosureSlaResponseFollowUpClosureStatus
  acknowledgementRecords: Array<BackendRecord<>>
  closeoutEvidenceRecords: Array<BackendRecord<>>
  deliveryEvidence: Array<BackendRecord<{
    request: NotificationDeliveryPayload
    result: NotificationDeliveryResult
  }>>
  ...
  auditHistory: Array<{
    action: 'closure_package_acknowledgement_closeout_notification_closure_package_acknowledgement_final_evidence_acknowledgement_closure_delivery_acknowledgement_closure_delivery_acknowledgement_final_evidence_delivery_acknowledgement_closeout_evidence_delivery_acknowledgement_closure_delivery_acknowledgement_closeout_evidence_delivery_acknowledgement_finalized'
    actor: string
    timestamp: string
    status: ClosureSlaResponseFollowUpClosureStatus
    summary: string
