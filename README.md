...
2. Migrate existing extracted panels to shared `PanelHeader`, `Metadata`, `StatusChip`, and title-formatting primitives.
3. Extract remaining Backend history lists such as Closure SLA queue, governance response history, and SLA package history.
