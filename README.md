...
1. Continue extracting the remaining closeout acknowledgement closure/package cards from `BackendRetryCloseoutGovernancePanel.tsx` one balanced subtree at a time.
